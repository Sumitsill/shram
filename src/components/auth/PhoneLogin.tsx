...
import { Phone, User, ArrowRight, Heart, Smartphone } from 'lucide-react';
      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">SHRAM</h1>
              <p className="text-gray-600">Empowering Lives</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full bg-gradient-to-r from-blue-600 to-green-600 text-white py-3 rounded-xl font-semibold transition-all duration-200 flex items-center justify-center space-x-2 ${
                isLoading 
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-xl border border-blue-200">
            <div className="flex items-start space-x-3">
              ...
              <div className="text-sm text-blue-800">
                ...
                <p>We'll send a 6-digit OTP to your mobile number for secure access to the SHRAM platform.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-8 text-sm text-gray-500">
          ...
          <p className="mt-2">
            ...
            <span className="font-semibold text-gray-600">SHRAM Platform</span>
          </p>
        </div>
      </div>
    </div>
